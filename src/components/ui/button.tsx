  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium font-body transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // Victorian/Mansion Variants
        mansion:
          "bg-gradient-to-r from-primary to-dusty-rose text-primary-foreground shadow-card hover:shadow-elevated hover:-translate-y-0.5 border border-primary/20",
        gold:
          "bg-gradient-to-r from-gold to-gold-light text-accent-foreground shadow-gold hover:shadow-elevated hover:-translate-y-0.5 font-semibold",
        elegant:
          "bg-card text-foreground border-2 border-gold/40 shadow-soft hover:border-gold hover:shadow-gold hover:bg-gold/5",
        magic:
          "bg-gradient-to-r from-primary via-gold to-primary bg-[length:200%_100%] text-primary-foreground animate-shimmer shadow-card hover:shadow-elevated",
      },
      size: {
